...
Esquema de versão: `v1.21.2-oracle.N` onde `N` cresce a cada release da fork. O fork foi cortado do `gabriel-sousa99/lerd@v1.21.2`; o auto-update (`lerd update`) consulta este repo.
