...
func setup(t *testing.T) {
	...
	// The Oracle fork defaults DNS.TLD to "localhost"; these upstream grouping
	// tests assert on ".test" domains, so pin the TLD the way a user who opted
	// into lerd-managed DNS would. Keeps the grouping logic exercised against a
	// concrete, stable TLD.
